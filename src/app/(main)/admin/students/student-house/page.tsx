...
const mockHouses = [
  { id: "1", name: "Purple", description: "This is for students in purple house" },
  { id: "2", name: "Green", description: "Green house" },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold">Manage House</h1>
        ...
        <div className="lg:col-span-2">
          <Card>
            ...
            <CardContent className="pt-6 space-y-4">
              <div>
                <label htmlFor="houseName" className="block text-sm font-medium text-foreground mb-1">Name</label>
                <Input id="houseName" placeholder="" />
              </div>
              <div>
                <label htmlFor="houseDescription" className="block text-sm font-medium text-foreground mb-1">Description</label>
                <Textarea id="houseDescription" placeholder="" className="min-h-[100px]" />
              </div>
          ...
          <Card>
            ...
            <CardContent className="p-4 space-y-4">
              ...
              <div className="mt-4 flex items-center justify-between text-sm text-muted-foreground">
                <div>Showing 1 to {mockHouses.length} of {mockHouses.length} entries</div>
