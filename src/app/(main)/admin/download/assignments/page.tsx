  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold">Manage Assignment</h1>
      ...
      <Card className="shadow-sm">
        <CardHeader className="bg-muted/50 p-4 border-b flex flex-row items-center justify-between">
          <CardTitle className="text-lg font-semibold text-foreground">NEW ASSIGNMENT</CardTitle>
          <Button size="sm" className="bg-blue-500 hover:bg-blue-600 text-white">
            <PlusCircle className="mr-2 h-4 w-4" />
            ADD NEW ASSIGNMENT HERE
            {/* Using Minus for the blue line effect as per image */}
